(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactPillSelector"] = factory(require("react"));
	else
		root["ReactPillSelector"] = factory(root["React"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCSSTransitionGroup = __webpack_require__(2);
	...
	var DropBoxContent = React.createClass({
		displayName: 'DropBoxContent',

		render: function () {
			return React.createElement(
				'div',
				{ className: 'drop-box-content' },
				this.props.children
			);
		}
	});
	...
	var DropButton = React.createClass({
		...
		getChildElementByType: function (type) {
			...
			return children.filter(function (childElement) {
				return childElement.type.displayName === type;
			});
		},
		...
		handleOutsideClick: function (event) {
			...
			if (dropBoxDOM && dropBoxDOM.contains(event.target) || buttonDOM && buttonDOM.contains(event.target) || !this.state.open) return;
			//close the box
			this.toggleDropBox();
		},
		render: function () {
			...
			if (this.state.open) {
				dropBox = React.createElement(
					'div',
					{ ref: 'dropBox', className: dropBoxClassName, key: 'drop-box' },
					dropBoxContent
				);
				buttonStatus = 'open';
			}
			if (this.props.transitionOn) {
				transitionGroup = React.createElement(
					ReactCSSTransitionGroup,
					{ transitionName: 'drop-box-transition', transitionEnterTimeout: 300, transitionLeaveTimeout: 300 },
					dropBox
				);
			} else transitionGroup = dropBox;
			return React.createElement(
				'div',
				{ className: 'react-drop-button' + ' ' + this.props.layoutMode },
				React.createElement(
					'button',
					{ ref: 'button', className: buttonStatus + ' rdb-button', onClick: this.toggleDropBox },
					dropTrigger
				),
				transitionGroup
			);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/sass-loader/index.js?outputStyle=expanded&includePaths[]=/Users/stephensmith/Desktop/gitRepos/react-drop-button/node_modules!./react-drop-button.scss", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/sass-loader/index.js?outputStyle=expanded&includePaths[]=/Users/stephensmith/Desktop/gitRepos/react-drop-button/node_modules!./react-drop-button.scss");
